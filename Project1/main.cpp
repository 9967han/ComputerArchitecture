...
void classifyStr(string str) {
    ...
    if(opCode.compare("000000") == 0) { // R-Type
        ...
        if(func.compare("100000") == 0) { //add
            ...
            cout << "sll " << REG << strToDec(rd) << ", " <<  REG << strToDec(rt) << ", " << strToDec(sa) << endl;
            ...
            cout << "sra " << REG << strToDec(rd) << ", " <<  REG << strToDec(rt) << ", " <<  strToDec(sa) << endl;
            ...
            cout << "srl " << REG << strToDec(rd) << ", " <<  REG << strToDec(rt) << ", " <<  strToDec(sa) << endl;
        ...
        if(opCode.compare("001000") == 0){ // addi
            ...
            cout << "slti " << REG << strToDec(rt) << ", " << REG << strToDec(rs) << ", " << strToDec(im) << endl;
        } else if(opCode.compare("001011") == 0){ // sltiu
            cout << "sltiu " << REG << strToDec(rt) << ", " << REG << strToDec(rs) << ", " << strToDec(im) << endl;
